/*!
 * TableIde.js - Table IDE
 * Version: 2.0.0
 * Author: Bonzai Carn
 * License: MIT
 * Repository: https://github.com/canworkstudios/TAFNE
 * 
...
(function (factory) {
    ...
    // ===================================================================================
    // 3. TABLE_IDE CORE CLASS
    // ===================================================================================

    class TableIdeCore {
        constructor(container, options) {
            this.container = $(container);
            this.options = $.extend({}, TABLE_IDE.options, options);
        ...
        initAccordions() {
            $(document).off('click.table-ide-accordion').on('click.table-ide-accordion', '.accordion-header', function () {
        ...
        initHeaderAccordion() {
            $(document).off('click.table-ide-header-accordion').on('click.table-ide-header-accordion', '.accordion', function () {
        ...
        initSpSelectors() {
            $(document).off('click.table-ide-sp-selector').on('click.table-ide-sp-selector', '.sp-option', function () {
                const $option = $(this);
        ...
        initCrosshair() {
            ...
            $(document).off('mouseenter.table-ide-crosshair mouseleave.table-ide-crosshair')
                .on('mouseenter.table-ide-crosshair', '.crosshair-table td, .crosshair-table th', function () {
                ...
                .on('mouseleave.table-ide-crosshair', '.crosshair-table', function () {
        ...
        destroy() {
            $(document).off('.table-ide-accordion .table-ide-header-accordion .table-ide-sp-selector .table-ide-crosshair');
    ...
    $.fn.tableIde = function (options) {
        return this.each(function () {
            const $this = $(this);
            let instance = $this.data('table-ide');

            if (!instance) {
                instance = new TableIdeCore(this, options);
                $this.data('table-ide', instance);
            }
    ...
    TABLE_IDE.autoInit = function () {
        $('.crosshair-table, .tablecoil').each(function () {
            if (!$(this).data('table-ide-initialized')) {
                const tableIde = new TableIdeCore(this, TABLE_IDE.options);
                $(this).data('table-ide-initialized', true);
                $(this).data('table-ide-instance', tableIde);
            }
        });
    };

    // Enable crosshair on specific table
    TABLE_IDE.enableCrosshair = function (selector) {
        $(selector).each(function () {
            const instance = $(this).data('table-ide-instance');
            if (instance) {
                instance.crosshairEnabled = true;
                instance.initCrosshair();
            } else {
                const tableIde = new TableIdeCore(this, { enableCrosshair: true });
                $(this).data('table-ide-instance', tableIde);
            }
        });
    };
    ...
    // Transpose table
    TABLE_IDE.transpose = function (selector) {
        const instance = $(selector).data('table-ide-instance');
        if (instance) {
    ...
    $(document).ready(function () {
        // Auto-initialize tables with TABLE_IDE classes
        TABLE_IDE.autoInit();
